...
RUN dotnet restore "src/GarageFlow.Api/GarageFlow.Api.csproj"

COPY . .
RUN dotnet publish "src/GarageFlow.Api/GarageFlow.Api.csproj" -c Release -o /app/publish /p:UseAppHost=false
