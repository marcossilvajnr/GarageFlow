...
- `src/GarageFlow.Infrastructure/Persistence/Configurations/SupplyConfiguration.cs`
- `src/GarageFlow.Infrastructure/Persistence/Repositories/SupplyRepository.cs`
