...
- Implementação dos testes E2E (fica para tasks 042-044).
- Setup de infraestrutura E2E em banco real (fica para task-041).
...
- [x] Mapeamento para tasks 041-044 explícito.
...
- Mapeamento explícito para implementação:
  - `task-041` (setup real DB), `task-042`, `task-043`, `task-044`.
