...
- SonarQube remoto não faz parte da CI padrão; a análise Sonar está documentada como fluxo local opcional em [operations-and-quality.md](operations-and-quality.md).
