...
public sealed class CompleteDiagnosticHandler(IServiceOrderRepository serviceOrderRepository)
{
    public async Task<ServiceOrderDto> HandleAsync(
        CompleteDiagnosticCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        serviceOrder.CompleteDiagnostic(command.Description);
