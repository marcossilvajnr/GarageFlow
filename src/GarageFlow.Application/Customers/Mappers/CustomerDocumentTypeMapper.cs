...
namespace GarageFlow.Application.Customers.Mappers;

internal static class CustomerDocumentTypeMapper
{
    internal static DomainCustomerDocumentType ToDomain(ApplicationCustomerDocumentType documentType) =>
        documentType switch
        {
            ...
            _ => throw new DomainException(DomainErrorMessages.InvalidDocumentType)
        };
