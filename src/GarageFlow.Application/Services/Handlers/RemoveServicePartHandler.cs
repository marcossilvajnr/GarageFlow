...
public sealed class RemoveServicePartHandler(IServiceRepository serviceRepository)
{
    public async Task HandleAsync(RemoveServicePartCommand command, CancellationToken cancellationToken = default)
    {
        ...
        service.RemovePart(command.PartId);
